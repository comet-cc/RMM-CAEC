...
#define S2TTE_CREATE_FLAG_RO            (1UL << 62)
...
#define S2TTE_INVALID_RIPAS_RAM_READ_ONLY  (S2TTE_INVALID_RIPAS_RAM | S2TTE_CREATE_FLAG_RO)
...
#define S2TTE_AP_RO                     (1UL << S2TTE_AP_SHIFT)
...
#define S2TTE_ATTRS_LPA2	(S2TTE_MEMATTR_FWB_NORMAL_WB | S2TTE_AP_RW | \
				 S2TTE_AF)
#define S2TTE_ATTRS_LPA2_RO      (S2TTE_MEMATTR_FWB_NORMAL_WB | S2TTE_AP_RO | \
                                 S2TTE_AF)
#define S2TTE_ATTRS_LPA2_MASK	(S2TTE_MEMATTR_MASK | S2TTE_AP_MASK | S2TTE_AF)
#define S2TTE_ATTRS		(S2TTE_ATTRS_LPA2 | S2TTE_SH_IS)
#define S2TTE_ATTRS_RO          (S2TTE_ATTRS_LPA2_RO | S2TTE_SH_IS)
...
#define S2TTE_BLOCK_RO          (S2TTE_ATTRS_RO | S2TTE_L012_BLOCK)
#define S2TTE_BLOCK_LPA2	(S2TTE_ATTRS_LPA2 | S2TTE_L012_BLOCK)
#define S2TTE_BLOCK_LPA2_RO     (S2TTE_ATTRS_LPA2_RO | S2TTE_L012_BLOCK)
#define S2TTE_PAGE		(S2TTE_ATTRS | S2TTE_L3_PAGE)
#define S2TTE_PAGE_RO           (S2TTE_ATTRS_RO | S2TTE_L3_PAGE)
#define S2TTE_PAGE_LPA2		(S2TTE_ATTRS_LPA2 | S2TTE_L3_PAGE)
#define S2TTE_PAGE_LPA2_RO      (S2TTE_ATTRS_LPA2_RO | S2TTE_L3_PAGE)
