...
static const struct smc_handler smc_handlers[] = {
	...
	HANDLER(APT_CREATE,		3, 0, smc_apt_create,		 true,  true),
	HANDLER(APT_DESTROY,		2, 0, smc_apt_destroy,		 true,  true),
	...
	HANDLER(CSDATA_CREATE,          5, 0, smc_csdata_create,         true, false),
        HANDLER(CSDATA_DESTROY,         2, 2, smc_csdata_destroy,        true, true),
