...
void handle_rsi_shared_key(struct rec *rec, struct rmi_rec_exit *rec_exit,
                 struct rsi_result *res);
void handle_rsi_shared_key_set_master(struct rec *rec, struct rmi_rec_exit *rec_exit,
                 struct rsi_result *res);
void handle_rsi_shared_key_set_slave(struct rec *rec, struct rmi_rec_exit *rec_exit,
                 struct rsi_result *res);
void handle_rsi_shared_key_get(struct rec *rec, struct rmi_rec_exit *rec_exit,
                 struct rsi_result *res);
